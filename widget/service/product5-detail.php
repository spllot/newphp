...
EOD;
			...
			// $photos .= (($data['Slide'] == 1 && $data['Slide2'] != "") ? '<li class="J_ECPM service-in-pic" style="margin-top:-13px;"><img alt="吉達資訊圖片輪播二" src="' . $data['Slide2'] . '" style="width:396px; height:248px"></li>' : "");
			// $photos .= (($data['Slide'] == 1 && $data['Slide3'] != "") ? '<li class="J_ECPM service-in-pic" style="margin-top:-13px;"><img alt="吉達資訊圖片輪播三" src="' . $data['Slide3'] . '" style="width:396px; height:248px"></li>' : "");
			// $photos .= (($data['Slide'] == 1 && $data['Slide4'] != "") ? '<li class="J_ECPM service-in-pic" style="margin-top:-13px;"><img alt="吉達資訊圖片輪播四" src="' . $data['Slide4'] . '" style="width:396px; height:248px"></li>' : "");
