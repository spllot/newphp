...
EOD;
			if($data['Cashflow'] == 1){
				$onclick = ((!empty($_SESSION['member'])) ? "parent.Dialog('buynow.php?id={$data['No']}');":"window.location.href='member_login.php?url=" . urlencode("service_product2_detail.php?no={$data['No']}") . "';");
