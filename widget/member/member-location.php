...
<table width=100% cellpadding=10 style="background:white; height:500px">
	<tr>
		<td align="center"><form name="iForm" method="post" action="member_location_save.php" style="margin:0">
...
?>
<div id="locationForm" class="centerForm" style="padding-bottom:20px;">
<?=$WEB_CONTENT?>
</div>
