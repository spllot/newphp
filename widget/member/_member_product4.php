			...
			$WEB_CONTENT .= <<<EOD
				<tr>
					<td style="text-align:left; background:white">
						<div style="width:676px; height:279px; overflow:hidden; background:url('./images/bg_m_product4.png');">
									...
									<tr>
										<td style="width:348px; height:22px; color:white">
											<table cellpadding="0" cellspacing="0" border=0 style="width:348px">
												<tr>
													<td style="width:160px; padding-left:15px; height:22px; color:white; text-align:center; vertical-align:bottom; font-size:11pt"><div style="width:160px; height:18px; overflow:hidden; text-align:center; padding-top:4px;">{$data['TName']}</div></td>
